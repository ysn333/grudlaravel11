...
<body>
    <div class=" grid place-items-center">
        <div class="container ">
            ...
            <form method="POST" class="w-100 p-5" action="<?php echo e(route('store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="grid place-items-center">
                    <div class="w-80">
                        <div class="label">
                        ...
                        <input type="text"  id="name" name="name" placeholder="Type here" class="input input-bordered w-full" value="<?php echo e(old('name')); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <input type="text" id="description" name="description" placeholder="Type here" class="input input-bordered w-full" value="<?php echo e(old('description')); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                        <button class="btn w-full mt-5 w-80 btn-active btn-primary" >Submit</button>
                    </div>
                </div>
            </form>
        </div>
