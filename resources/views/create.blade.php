...
<body>
    <div class=" grid place-items-center">
        <div class="container ">
            ...
            <form method="POST" class="w-100 p-5" action="{{route('store')}}" enctype="multipart/form-data">
                @csrf
                <div class="grid place-items-center">
                    <div class="w-80">
                        <div class="label">
                        ...
                        <input type="text"  id="name" name="name" placeholder="Type here" class="input input-bordered w-full" value="{{old('name')}}"/>
                        {{-- error --}}
                        @error('name')
                        ...
                        <input type="text" id="description" name="description" placeholder="Type here" class="input input-bordered w-full" value="{{old('description')}}"/>
